    ...
    try {
        ...
        const response = await axios({
            ...
            data: {
                ...
                subject: 'Registration OTP Social Snap',
                htmlContent: `<p>Your registration otp for Social Snap is ${otp}</p>`,
                replyTo: {
                    email: 'ashutoshacharya908@gmail.com',
                    name: 'Social Snap'
                }
    ...
    try {
        ...
        const response = await axios({
            ...
            data: {
                ...
                subject: 'Reset Password OTP Social Snap',
                htmlContent: `<p>Your reset password otp for Social Snap is ${otp}</p>`,
                replyTo: {
                    email: 'ashutoshacharya908@gmail.com',
                    name: 'Social Snap'
                }
